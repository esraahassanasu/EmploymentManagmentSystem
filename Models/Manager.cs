...
namespace EmploymentManagmentSystem.Models
{
    public class Manager : Employee
    {
        ...
        public Manager(int id, string firstName, string lastName, string email, string phoneNumber, DateTime dateOfBirth, DateTime hireDate, int departmentId, decimal salary)
            : base(id, firstName, lastName, email, phoneNumber, dateOfBirth, hireDate, departmentId, salary)
        {
